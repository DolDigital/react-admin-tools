                ...
                case 1:
                    {
                        ...
                        query = __assign({}, react_admin_1.fetchUtils.flattenObject(filter), { _sort: field + ':' + order, _start: (page - 1) * perPage, _limit: perPage });
                        if (q)
                            query['_q'] = q;
                ...
                case 3:
                    {
                        ...
                        query = __assign({}, react_admin_1.fetchUtils.flattenObject(params.filter), (_g = {}, _g[params.target] = params.id, _g._sort = field + ':' + order, _g._start = (page - 1) * perPage, _g._limit = perPage, _g));
                        url = apiUrl + "/" + resource + "?" + query_string_1.stringify(query);
                        return [3 /*break*/, 11];
                    }
                    _h.label = 4;
