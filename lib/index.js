...
exports.buildAuthProvider3 = function (apiUrl) {
    return {
        login: function (_a) {
...
exports.buildAuthProvider = function (apiUrl) {
    return function (type, params) {
        switch (type) {
            case react_admin_1.AUTH_LOGIN:
                var username = params.username, password = params.password;
                return getLoginAction(apiUrl)(username, password);
            case react_admin_1.AUTH_LOGOUT:
                return getLogoutAction(apiUrl)(params);
            case react_admin_1.AUTH_ERROR:
                console.log(params);
                var error = params.error;
                return getErrorAction(apiUrl)(error);
            case react_admin_1.AUTH_CHECK:
                return getCheckAction(apiUrl)();
            case react_admin_1.AUTH_GET_PERMISSIONS:
