...
export default (function (apiUrl, httpClient) {
    ...
    var computeFilters = function (filters) {
        ...
        var flattened = fetchUtils.flattenObject(filter);
        var returner = {};
                ...
                case 3:
                    {
                        ...
                        query = __assign({}, fetchUtils.flattenObject(params.filter), (_f = {}, _f[params.target] = params.id, _f._sort = field + ':' + order, _f._start = (page - 1) * perPage, _f._limit = perPage, _f));
                        url = apiUrl + "/" + resource + "?" + stringify(query);
                        return [3 /*break*/, 11];
                    }
                    _g.label = 4;
