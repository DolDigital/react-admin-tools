...
export default (function (apiUrl, httpClient) {
    ...
    var convertDataRequestToHTTP = function (type, resource, params) { return __awaiter(_this, void 0, void 0, function () {
        var url, options, _a, _b, page, perPage, _c, field, order, _d, q, filter, query, _e, page, perPage, _f, field, order, query, query;
        var _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    _a = type;
                    switch (_a) {
                        case GET_LIST: return [3 /*break*/, 1];
                        case GET_ONE: return [3 /*break*/, 2];
                        case GET_MANY_REFERENCE: return [3 /*break*/, 3];
                        case UPDATE: return [3 /*break*/, 4];
                        case CREATE: return [3 /*break*/, 6];
                        case DELETE: return [3 /*break*/, 8];
                        case GET_MANY: return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 10];
                case 1:
                    {
                        ...
                        _d = params.filter, q = _d.q, filter = __rest(_d, ["q"]);
                        query = __assign({}, fetchUtils.flattenObject(filter), { _sort: field + ':' + order, _start: (page - 1) * perPage, _limit: perPage });
                        if (q)
                            query['_q'] = q;
                ...
                case 3:
                    {
                        ...
                        _f = params.sort, field = _f.field, order = _f.order;
                        query = __assign({}, fetchUtils.flattenObject(params.filter), (_g = {}, _g[params.target] = params.id, _g._sort = field + ':' + order, _g._start = (page - 1) * perPage, _g._limit = perPage, _g));
                        url = apiUrl + "/" + resource + "?" + stringify(query);
                        return [3 /*break*/, 11];
                    }
                    _h.label = 4;
